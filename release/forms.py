...
class MainInfoForm(ModelForm):
    class Meta:
        ...
        help_texts = {
            ...
            'photo_link':'Вставьте ссылку на скачивание ваших фото или прикрепите фото ниже. Инструкции по подбору фотографий по ссылке: <a href = "https://disk.yandex.ru/d/qkZJhwS-Q9qc1w" target="_blank" style="text-decoration: underline;">https://disk.yandex.ru/d/qkZJhwS-Q9qc1w</a>.',
...
class AudioForm(ModelForm):
    class Meta:
        ...
        fields = '__all__'
        help_texts = {
            'audio_link': 'Вы можете оставить ссылку на весь материал или прикрепить его далее в этой таблице.',
            'clean_link': 'Треки, в которых присутствует мат, недоступны на данных территориях: Belarus/Brunei/Burkina Faso/Nepal/Uzbekistan. А так же в подписке для детей. Нам нужно отгрузить Clean version, чтобы на указанных выше территориях и подписках тоже могли наслаждаться вашим творчеством! Обращаем ваше внимание, что при отказе предоставления clean version, мы делаем их самостоятельно без дополнительного согласования с вами.',
