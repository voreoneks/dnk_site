...
class MainInfo(models.Model):
    ...
    photo = models.ImageField(upload_to = update_filename, verbose_name='Прикрепить фото', blank=True, null=True)
    ...
    cover_psd = models.FileField(upload_to = update_filename, verbose_name='Обложка в слоях (PSD)', blank=True, null=True)
...
class Audio(models.Model):
    ...
    lexis = models.CharField(max_length=25, choices=exist_choices, default='NONE', verbose_name='Ненормативная лексика в песне')
    audio_link = models.URLField(blank=True, null=True, verbose_name='Ссылка на материал')
    audio = models.FileField(upload_to = update_filename, verbose_name='Аудио (WAV)', blank=True, null=True)
    clean_link = models.FileField(upload_to = update_filename, verbose_name='Clean version трека (WAV)', blank=True, null=True)
    instrumental = models.FileField(upload_to = update_filename, verbose_name='Instrumental (минус)', blank=True, null=True)
    song_text = models.FileField(upload_to = update_filename, verbose_name='Текст песни', blank=True, null=True)
...
class Video(models.Model):
    ...
    video_preview = models.ImageField(upload_to = update_filename, verbose_name='Превью клипа', blank=True, null=True)
